...
pub const R32: Type = Type(0x3);

/// An opaque reference type with 64 bits.
pub const R64: Type = Type(0x4);

macro_rules! define_scalar_or_lane_types {
    ($($base:expr, $doc_prefix:literal, $doc_suffix:literal =>
        $b1:ident, $b8:ident, $b16:ident, $b32:ident, $b64:ident, $b128:ident,
        $i8:ident, $i16:ident, $i32:ident, $i64:ident, $i128:ident,
        $f32:ident, $f64:ident;
    )*) => {$(
        #[doc = $doc_prefix]
        #[doc = " boolean type with 1 bits"]
        #[doc = $doc_suffix]
        pub const $b1: Type = Type($base + 0);

        #[doc = $doc_prefix]
        #[doc = " boolean type with 8 bits"]
        #[doc = $doc_suffix]
        pub const $b8: Type = Type($base + 1);

        #[doc = $doc_prefix]
        #[doc = " boolean type with 16 bits"]
        #[doc = $doc_suffix]
        pub const $b16: Type = Type($base + 2);

        #[doc = $doc_prefix]
        #[doc = " boolean type with 32 bits"]
        #[doc = $doc_suffix]
        pub const $b32: Type = Type($base + 3);

        #[doc = $doc_prefix]
        #[doc = " boolean type with 64 bits"]
        #[doc = $doc_suffix]
        pub const $b64: Type = Type($base + 4);

        #[doc = $doc_prefix]
        #[doc = " boolean type with 128 bits"]
        #[doc = $doc_suffix]
        ...
        #[doc = $doc_suffix]
        pub const $i8: Type = Type($base + 6);

        #[doc = $doc_prefix]
        #[doc = "n integer type with 16 bits"]
        #[doc = $doc_suffix]
        pub const $i16: Type = Type($base + 7);

        #[doc = $doc_prefix]
        #[doc = "n integer type with 32 bits"]
        #[doc = $doc_suffix]
        pub const $i32: Type = Type($base + 8);

        #[doc = $doc_prefix]
        #[doc = "n integer type with 64 bits"]
        #[doc = $doc_suffix]
        pub const $i64: Type = Type($base + 9);

        #[doc = $doc_prefix]
        #[doc = "n integer type with 128 bits"]
        #[doc = $doc_suffix]
        pub const $i128: Type = Type($base + 0xa);

        #[doc = $doc_prefix]
        #[doc = " 32-bit floating point type represented in the IEEE 754-2008 *binary32* interchange format"]
        #[doc = $doc_suffix]
        pub const $f32: Type = Type($base + 0xb);

        #[doc = $doc_prefix]
        #[doc = " 64-bit floating point type represented in the IEEE 754-2008 *binary64* interchange format"]
        #[doc = $doc_suffix]
        pub const $f64: Type = Type($base + 0xc);
    )*};
}

define_scalar_or_lane_types!(
    LANE_BASE, "A", "."
        => B1, B8, B16, B32, B64, B128, I8, I16, I32, I64, I128, F32, F64;
    0x80, "A SIMD vector with 2 lanes containing a", " each"
        => B1X2, B8X2, B16X2, B32X2, B64X2, B128X2, I8X2, I16X2, I32X2, I64X2, I128X2, F32X2, F64X2;
    0x90, "A SIMD vector with 4 lanes containing a", " each"
        => B1X4, B8X4, B16X4, B32X4, B64X4, B128X4, I8X4, I16X4, I32X4, I64X4, I128X4, F32X4, F64X4;
    0xa0, "A SIMD vector with 8 lanes containing a", " each"
        => B1X8, B8X8, B16X8, B32X8, B64X8, B128X8, I8X8, I16X8, I32X8, I64X8, I128X8, F32X8, F64X8;
    0xb0, "A SIMD vector with 16 lanes containing a", " each"
        => B1X16, B8X16, B16X16, B32X16, B64X16, B128X16, I8X16, I16X16, I32X16, I64X16, I128X16, F32X16, F64X16;
    0xc0, "A SIMD vector with 32 lanes containing a", " each"
        => B1X32, B8X32, B16X32, B32X32, B64X32, B128X32, I8X32, I16X32, I32X32, I64X32, I128X32, F32X32, F64X32;
    0xd0, "A SIMD vector with 64 lanes containing a", " each"
        => B1X64, B8X64, B16X64, B32X64, B64X64, B128X64, I8X64, I16X64, I32X64, I64X64, I128X64, F32X64, F64X64;
);
